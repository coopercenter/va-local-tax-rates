...
table_20_2_vars   <- c("ExternalDataReference","RCC_tipping_fees")
table_20_2_labels <- c("Locality","Tipping Fee")

table_20_2 <- make_table(table_20_2_vars)
...
table_20_3_vars   <- c("ExternalDataReference","RCC_rec_serv_type","RCC_rec_charge_fee")
table_20_3_labels <- c("Locality","Provided Directly or Contracted","Service Fee")

table_20_3 <- make_table(table_20_3_vars)

opts <- options(knitr.kable.NA = "--")
 knitr::kable(table_20_3, 
