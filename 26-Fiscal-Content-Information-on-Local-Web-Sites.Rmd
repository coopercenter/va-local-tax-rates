...
table_24_1_vars   <- c("ExternalDataReference", "Web_exist", "Web_proposedBudget", "Web_adoptedBudget", "Web_taxRates", "Web_capitalImpPgrms", "Web_utilityCharges", "Web_landbookInfo", "Web_GISMapping", "Web_CAFR")
table_24_1_labels <- c("Locality","Have a Website?", "Information That Exists on Website, Proposed Budget", "Adopted Budget", "Tax Rates", "Capital Improvement Programs", "Utility Charges", "Landbook Information", "GIS Mapping*", "Audit (CAFR)*")
