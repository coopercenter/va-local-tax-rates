---
title: "va-local-tax-rates-Section-26"
author: "Emily Lien"
date: "6/16/2021"
...
ratesCounties <- 0
ratesTowns <- 0
improvementProgCities <- 0
improvementProgCounties <- 0
improvementProgTowns <- 0
utilitiesCities <- 0
utilitiesCounties <- 0
utilitiesTowns <- 0
landbookCities <- 0
...
table26.1a <- tibble("Locality (Cities)" = localityCities,"Have A Website?" = websiteCities, "Proposed Budget" = budgetPCities,"Adopted Budget" = budgetACities, "Tax Rates" = ratesCities, "Capital Improvement Programs"=improvementProgCities,"Utility Charges"=utilitiesCities,"Landbook Information" = landbookCities,"GIS Mapping" = GISCities, "Audit (CAFR)" = auditCities)

table26.1b <- tibble("Locality (Counties)" = localityCounties,"Have A Website?" = websiteCounties, "Proposed Budget" = budgetPCounties,"Adopted Budget" = budgetACounties, "Tax Rates" = ratesCounties, "Capital Improvement Programs"=improvementProgCounties,"Utility Charges"=utilitiesCounties,"Landbook Information" = landbookCounties,"GIS Mapping" = GISCounties, "Audit (CAFR)" = auditCounties)

table26.1c <- tibble("Locality (Towns)" = localityTowns,"Have A Website?" = websiteTowns, "Proposed Budget" = budgetPTowns,"Adopted Budget" = budgetATowns, "Tax Rates" = ratesTowns, "Capital Improvement Programs"=improvementProgTowns,"Utility Charges"=utilitiesTowns,"Landbook Information" = landbookTowns,"GIS Mapping" = GISTowns, "Audit (CAFR)" = auditTowns)

kable(table26.1a,caption="Table 26.1 Fiscal Content Information on Local Websites, 2019")
kable(table26.1b,caption="Table 26.1 Fiscal Content Information on Local Websites, 2019 (continued)")
kable(table26.1c,caption="Table 26.1 Fiscal Content Information on Local Websites, 2019 (continued)")
```
